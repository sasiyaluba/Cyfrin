...
contract AttackerForReen is IFlashLoanReceiver {
    ...
    constructor(ThunderLoan _thunderLoan, IERC20 _tokenA, uint256 _amount) {
...
contract AttackForMinimizeFee is IFlashLoanReceiver {
    ...
    constructor(ThunderLoan _thunderLoan, IERC20 _tokenA, uint256 _amount, MockTSwapPool _pool) {
        thunderLoan = _thunderLoan;
        tokenA = _tokenA;
        amount = _amount;
        tSwapPool = _pool;
